...
# load cleaned up Titled Tuesday 2023 results
...
saveRDS(object = player_df, file = "input/player_2023_df.RDS")
...
matches_df <- TT_long
saveRDS(object = matches_df, file = "input/matches_2023_df.RDS")
...
saveRDS(object = results_df, file = "input/results_2023_df.RDS")
